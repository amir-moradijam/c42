...
def draw_scoreboard(screen, p1_col, p2_col, wins1, draws, wins2):
    rect = pygame.Rect(0, 0, WINDOW_WIDTH, SCOREBOARD_HEIGHT)
    pygame.draw.rect(screen, p1_col, (0, 0, WINDOW_WIDTH // 2, rect.height))
    pygame.draw.rect(screen, p2_col, (WINDOW_WIDTH // 2, 0, WINDOW_WIDTH // 2, rect.height))
...
def render(screen, board, colours, last_pos, stats, p1_col, p2_col):
    draw_scoreboard(screen, p1_col, p2_col, stats['p1_wins'], stats['draws'], stats['p2_wins'])
...
def animate_drop(screen, board, col, row_dest, colours, piece_code, last_pos, stats, p1_col, p2_col):
    ...
    while y < target_y:
        ...
        y += DROP_SPEED
        render(screen, board, colours, last_pos, stats, p1_col, p2_col)
