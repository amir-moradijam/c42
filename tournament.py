...
def main():
    ...
    for game in range(GAMES):
        ...
        while not game_over:
            ...
            p1_col = RED if p1_is_red else YELLOW
            p2_col = YELLOW if p1_is_red else RED
            render(screen, board, colours, last_move, stats, p1_col, p2_col)
            ...
            animate_drop(screen, board, col, row, colours, piece_code, last_move, stats, p1_col, p2_col)
